...
<head>
    ...
    <title>Pending Activations - PGIM Digital Library</title>
    ...
    <style>
        ...
        .btn-approve { padding: 0.4rem 0.8rem; background: #10b981; color: #fff; border: none; border-radius: 6px; font-size: 0.85rem; font-weight: 600; cursor: pointer; transition: background 0.2s; white-space: nowrap; }
        .btn-approve:hover { background: #059669; }
        .btn-reject { padding: 0.4rem 0.8rem; background: #ef4444; color: #fff; border: none; border-radius: 6px; font-size: 0.85rem; font-weight: 600; cursor: pointer; transition: background 0.2s; white-space: nowrap; margin-left: 0.25rem; }
        .btn-reject:hover { background: #dc2626; }
        .badge-pending { background: #fef3c7; color: #92400e; padding: 0.25rem 0.6rem; border-radius: 9999px; font-size: 0.75rem; font-weight: 600; text-transform: uppercase; }
        ...
        <main class="main-content">
            <div class="content-view">
                <div class="view-header">
                    <h1>Pending Account Activations</h1>
                </div>
                ...
                <div class="admin-card">
                    <table>
                        ...
                        <tbody>
                            <?php if (count($pending_users) > 0): ?>
                                <?php foreach ($pending_users as $u): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo htmlspecialchars($u['speciality'] ?? '-'); ?> / 
                                            <?php echo htmlspecialchars($u['slmc_number'] ?? '-'); ?>
                                        </td>
                                        ...
                                        <td style="display: flex; gap: 0.5rem; align-items: center;">
                                            ...
                                            <form method="POST" style="margin:0;" onsubmit="return confirm('Are you sure you want to reject this registration?');">
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="6" style="text-align: center;">No pending activations.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
